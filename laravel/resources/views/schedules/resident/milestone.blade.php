...
@section('content')
	...
	<div id = "Resident Form">
        ...
        @endif
                ...
                <input align = "right" type="button" value="Next" class='btn btn-md btn-success' id="{{ $id }}" onclick="NextToConfirm(this.id);">

								<script type="text/javascript">
								function NextToConfirm(id)
								{
										...
										if (current_url.includes('secondday')) {
											url = url + "/schedule/secondday/" + id +"/";
										} else {
											url = url + "/schedule/thirdday/" + id +"/";
										}
