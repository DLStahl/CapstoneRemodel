...
@section('content')
        ...
        <tbody>
            ...
            @foreach ($milestone as $mile)
                ...
                <tr id="{{ $mile['id'] }}">
                    ...
                    <td align="left">
                        <div contenteditable="true" class="{{ $mile['id'] }} code">{{ $mile['category'] }}</div>
                    </td>
                    <td align="left">
                        <div contenteditable="true" class="{{ $mile['id'] }} category">{{ $mile['title'] }}</div>
                    </td>
                    <td align="left">
                        <div contenteditable="true" class="{{ $mile['id'] }} detail">{{ $mile['detail'] }}</div>
                    </td>

                    <td class="b1">
                        <input align="center" onclick="updateMilestone({{ $mile['id'] }});" value="Update" type="button"
                            class="btn btn-md btn-success {{ $mile['id'] }} update" disabled="true">
                        <input align="right" onclick="undoMilestone();" value="Undo" type="button"
                            class="btn btn-md btn-success {{ $mile['id'] }} undo" disabled="true">
    ...
    <script type="text/javascript">
        ...
        function addMilestone() {
            var code = $('#code').val();
            myObjects = Object.keys(codes).map(function(item) {
                return codes[item];
            });
