                ...
                <form method="POST" action="editDB">
                    <div class="form-group">
                        ...
                        <td align="left">
                            ...
                            <br>
                            <label> Code:</label>
                            <input type="number" name="lead_surgeon_code" value="{{ $data['lead_surgeon_code'] }}"
                                required>
                        </td>
                        <td align="left"><input type="text" name="patient_class" value="{{ $data['patient_class'] }}"
                                required></td>
                        <td align="left"><input type="time" name="start_time" value="{{ $data['start_time'] }}" required>
                        </td>
                        <td align="left"><input type="time" name="end_time" value="{{ $data['end_time'] }}" required>
                        </td>
                        <td align="left">
                            {{ $data['assignment'] }}
                            <br>
